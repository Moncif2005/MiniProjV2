      ...
      builder: (ctx) {
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              title: Text(AppLocalizations.of(context).rateThisCourse, style: TextStyle(fontFamily: 'Inter', fontWeight: FontWeight.bold)),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text(AppLocalizations.of(context).howWasExperience, style: TextStyle(color: Colors.grey)),
...
GestureDetector(
  ...
  child: Row(
    mainAxisSize: MainAxisSize.min,
    children: [
      Text('${AppLocalizations.of(context).byInstructor} ${course.instructorName}', style: TextStyle(color: AppColors.primary, fontSize: 14, fontFamily: 'Inter', fontWeight: FontWeight.w600)),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text('${AppLocalizations.of(context).yourProgress}: $percentage%', style: TextStyle(color: c.textPrimary, fontSize: 12, fontWeight: FontWeight.bold)),
                                  ],
                                ),
