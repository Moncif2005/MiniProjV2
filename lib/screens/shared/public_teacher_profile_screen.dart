  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Teacher Profile', style: TextStyle(fontFamily: 'Inter', fontWeight: FontWeight.bold)),
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, userSnap) {
          ...
          if (userData == null) return Center(child: Text('User not found', style: TextStyle(color: c.textMuted)));
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    Text('Courses by this Teacher', style: TextStyle(color: c.textPrimary, fontSize: 18, fontFamily: 'Inter', fontWeight: FontWeight.w700)),
                    const SizedBox(height: 16),
                  ]),
                ),
              ),
              ...
              StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, coursesSnap) {
                  ...
                  if (!coursesSnap.hasData || coursesSnap.data!.docs.isEmpty) {
                    return const SliverToBoxAdapter(child: Center(child: Text('No courses published yet.', style: TextStyle(color: Colors.grey))));
                  }
