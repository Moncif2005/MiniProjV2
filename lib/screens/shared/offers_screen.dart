...
class _OffersScreenState extends State<OffersScreen> {
  ...
  Future<void> _applyToJob(Map<String, dynamic> offer) async {
    ...
    if (user == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context).pleaseSignInApply),
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        title: Text(AppLocalizations.of(context).applyForJob),
        content: Text(
  ...
  Future<void> _withdrawFromJob(Map<String, dynamic> offer) async {
    ...
    final confirmed = await showDialog<bool>(
      context: context,
      builder: (_) => AlertDialog(
        title: Text(AppLocalizations.of(context).withdrawApplication),
        content: const Text(
            ...
            onTap: () async {
              ...
              final confirmed = await showDialog<bool>(
                ...
                builder: (dialogContext) => AlertDialog(
                  ...
                  content: Text(AppLocalizations.of(context).deleteJobMsg),
                  actions: [
                    TextButton(onPressed: () => Navigator.pop(dialogContext, false), child: Text(AppLocalizations.of(context).cancel)),
                    FilledButton(
              ...
              if (confirmed == true && mounted) {
                ...
                if (mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    content: Text(AppLocalizations.of(context).jobDeleted), backgroundColor: AppColors.green));
                }
              }
            },
          ),
                        ...
                        child: Container(
                          ...
                          child: const Row(
                            children: [
                              ...
                              SizedBox(width: 4),
                              // Text(
                              //   AppLocalizations.of(context).postJobBtn,
                              //   style: TextStyle(
                              //     color: Colors.white,
                              //     fontSize: 14,
                              //     fontFamily: 'Inter',
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: AppLocalizations.of(context).searchJobsCompanies,
...
//                           const SizedBox(height: 16),
//                           Text(AppLocalizations.of(context).noOffersFound,
