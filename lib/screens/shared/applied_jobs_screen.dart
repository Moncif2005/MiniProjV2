...
class _AppliedJobsScreenState extends State<AppliedJobsScreen> {
  ...
  List<Map<String, String?>> get _filters => [
    ...
    {'label': AppLocalizations.of(context).pending, 'status': 'pending'},
    {'label': AppLocalizations.of(context).reviewing, 'status': 'reviewing'},
    {'label': AppLocalizations.of(context).interview, 'status': 'interview'},
    {'label': 'Accepted', 'status': 'accepted'},
    {'label': AppLocalizations.of(context).rejected, 'status': 'rejected'},
  ];
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              _OverviewStat(
                                value: '$reviewing',
                                label: AppLocalizations.of(context).reviewing,
                              ),
      ...
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(AppLocalizations.of(context).withdrawApplication),
