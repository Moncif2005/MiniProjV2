  ...
  Future<void> _deleteCV() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(AppLocalizations.of(context).deleteCv),
        content: Text(AppLocalizations.of(context).deleteCvConfirm),
        actions: [
          TextButton(
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            FilledButton(
              ...
              child: Text(AppLocalizations.of(context).save, style: TextStyle(fontFamily: 'Inter')),
            ),
          ],
        );
      },
          ...
          if (hasCv) ...[
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                ...
                label: Text(AppLocalizations.of(context).previewCv),
                style: FilledButton.styleFrom(
                  backgroundColor: AppColors.primary,
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                value: _type,
                items: [
                  DropdownMenuItem(value: 'project', child: Text(AppLocalizations.of(context).projectLabel)),
                  DropdownMenuItem(
                    value: 'external_cert',
                    child: Text(AppLocalizations.of(context).certificateItem),
                  ),
                ],
