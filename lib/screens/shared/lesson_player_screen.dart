                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ✅✅✅ الحل الجذري لخطأ setState: نستخدم StreamBuilder ونعتمد على بياناته مباشرة ✅✅✅
                      StreamBuilder<bool>(
                        stream: _progressService.isLessonCompletedStream(widget.courseId, widget.lessonId),
                        builder: (context, snap) {
                          // ✅ نأخذ القيمة من الـ Stream مباشرة، ولا نستخدم متغير محلي _isCompleted
                          ...
                          return SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              // ✅ الزر يتعطل تلقائياً إذا كانت isDone true
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: Text('Your progress is saved automatically when you mark a lesson as complete.', style: TextStyle(color: c.textSecondary, fontSize: 12))),
                          ],
                        ),
                      ),
                    ],
