...
onTap: () async {
  ...
  if (confirmed == true && mounted) {
    ...
    if (mounted && success) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(AppLocalizations.of(context).failedUpdateStatus),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text(AppLocalizations.of(context).postJobBtn, 
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('No ${_selectedTab == 0 ? AppLocalizations.of(context).active.toLowerCase() : AppLocalizations.of(context).jobClosed.toLowerCase()} jobs found', 
