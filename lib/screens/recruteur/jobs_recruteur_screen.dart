...
class _JobsRecruteurScreenState extends State<JobsRecruteurScreen> {
  ...
  List<Map<String, dynamic>> get _filtered =>
      _jobs.where((j) =>
        _selectedTab == 0 ? j['status'] == 'Active' : j['status'] == 'Closed'
      ).toList();
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text('${_jobs.where((j) => j['status'] == 'Active').length} active',
            ...
            Padding(
              ...
              child: Row(
                children: [
                  _Tab(label: 'Active', isSelected: _selectedTab == 0,
                      onTap: () => setState(() => _selectedTab = 0)),
                  const SizedBox(width: 12),
                  _Tab(label: 'Closed', isSelected: _selectedTab == 1,
              ...
              child: _filtered.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text('No ${_selectedTab == 0 ? 'active' : 'closed'} jobs',
                              style: TextStyle(
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _JobDetailCard(c: c, job: job);
                      },
                    ),
            ),
          ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _Tag(label: job['type'] as String,
                  icon: Icons.work_outline_rounded,
                  color: AppColors.primary),
              const SizedBox(width: 8),
              _Tag(label: job['salary'] as String,
          ...
          Row(
            children: [
              _Metric(icon: Icons.people_outline_rounded,
                  value: '${job['applicants']}', label: 'Applicants',
                  color: c.textSecondary),
              const SizedBox(width: 20),
              _Metric(icon: Icons.visibility_outlined,
                  value: '${job['views']}', label: 'Views',
                  color: c.textSecondary),
              const Spacer(),
              if (isActive)
                GestureDetector(
...
class _Metric extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(children: [
      ...
      Text('$value $label',
          style: TextStyle(
            color: color, fontSize: 12, fontFamily: 'Inter',
          )),
    ]);
  }
}
