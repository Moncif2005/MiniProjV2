  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).manage, style: TextStyle(color: c.textPrimary, fontFamily: 'Inter', fontWeight: FontWeight.w700)),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ── Actions ──
            Text(AppLocalizations.of(context).actions, style: TextStyle(color: c.textPrimary, fontSize: 16, fontFamily: 'Inter', fontWeight: FontWeight.w700)),
            const SizedBox(height: 16),
...
_ActionCard(
  ...
  title: AppLocalizations.of(context).editJobDetails,
  subtitle: AppLocalizations.of(context).updateJobSubtitle,
  onTap: () async {
    ...
    if (result == true && context.mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(AppLocalizations.of(context).jobUpdated), backgroundColor: AppColors.green,
      ));
    }
  },
),
      ...
      MaterialPageRoute(builder: (_) => ApplicantsScreen(
        ...
        offerTitle: offer['title'],
            ...
            _ActionCard(
              ...
              title: AppLocalizations.of(context).deactivateJob,
              subtitle: AppLocalizations.of(context).hideJob,
              isDestructive: true,
              onTap: () async {
                final confirmed = await showDialog<bool>(
                  context: context,
                  builder: (_) => AlertDialog(
                    title: Text(AppLocalizations.of(context).deactivateJob),
                    content: Text(AppLocalizations.of(context).deactivateJobMsg),
                    actions: [
                      TextButton(onPressed: () => Navigator.pop(context, false), child: Text(AppLocalizations.of(context).cancel)),
                      FilledButton(
                        style: FilledButton.styleFrom(backgroundColor: AppColors.red),
                        onPressed: () => Navigator.pop(context, true),
                        child: Text(AppLocalizations.of(context).deactivate, style: TextStyle(color: Colors.white)),
                      ),
                    ],
                  ),
                );
