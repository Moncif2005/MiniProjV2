...
class ApplicantsScreen extends StatelessWidget {
  ...
  const ApplicantsScreen({super.key, required this.offerId, required this.offerTitle});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Applicants', style: TextStyle(color: c.textPrimary, fontFamily: 'Inter', fontWeight: FontWeight.w700)),
        centerTitle: true,
      ),
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Applications for', style: TextStyle(color: c.textSecondary, fontSize: 14, fontFamily: 'Inter')),
              const SizedBox(height: 4),
              Text(offerTitle, style: TextStyle(color: c.textPrimary, fontSize: 18, fontFamily: 'Inter', fontWeight: FontWeight.w700)),
            ]),
          ),
                ...
                if (applicants.isEmpty) {
                  return Center(
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text('Applications will appear here', style: TextStyle(color: c.textMuted, fontSize: 14)),
                    ]),
                  );
                }
                      ...
                      onUpdateStatus: (status, message) async {
                        ...
                        if (context.mounted && success) {
                          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                            content: Text('Status updated ✓'), backgroundColor: AppColors.green,
                          ));
                        }
                      },
                    );
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Text('Applied: ${_formatDate(app['appliedAt'])}', style: TextStyle(color: c.textMuted, fontSize: 12, fontFamily: 'Inter')),
        ]),
      ]),
    );
  }
