    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavBar(
        ...
        items: [
          ...
          NavBarItem(icon: Icons.business_center_rounded, label: AppLocalizations.of(context).navJobs),
          NavBarItem(icon: Icons.people_rounded, label: AppLocalizations.of(context).navApplicants),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        AppLocalizations.of(context).findGreatHire,
                        style: TextStyle(
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: AppLocalizations.of(context).searchCandidates,
                  hintStyle: TextStyle(
                    color: c.textMuted,
                    fontSize: 15,
                    fontFamily: 'Inter',
...
final activeCount = jobs.where((j) => j['status'] == 'approved').length;                      return Container(
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      AppLocalizations.of(context).recruitmentHub,
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    const Icon(Icons.add_rounded, color: AppColors.purple, size: 18),
                                    const SizedBox(width: 6),
                                    Text(AppLocalizations.of(context).postNewJob, style: const TextStyle(color: AppColors.purple, fontSize: 14, fontFamily: 'Inter', fontWeight: FontWeight.w700)),
                                  ],
                                ),
                              ),
                            ),
            ...
            Row(
              ...
              children: [
                Text(
                  AppLocalizations.of(context).postedJobs,
                  style: TextStyle(
                    color: c.textPrimary,
                    fontSize: 20,
                    fontFamily: 'Inter',
                        ...
                        return Center(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Icon(
                                  _searchQuery.isNotEmpty ? Icons.search_off_rounded : Icons.work_off_outlined,
                                  size: 48,
                                  color: c.textMuted,
                                ),
                                const SizedBox(height: 12),
                                Text(
                                  _searchQuery.isNotEmpty ? 'No jobs match "$_searchQuery"' : 'No jobs posted yet',
                                  style: TextStyle(
                                    color: c.textMuted,
                                    fontSize: 16,
                                    fontFamily: 'Inter',
...
class _MiniStat extends StatelessWidget {
  ...
  final String value, label;
  final ThemeColors c;
  const _MiniStat({required this.icon, required this.value, required this.label, required this.c});
  ...
  Widget build(BuildContext context) => Row(
    children: [
      ...
      Text('$value $label', style: TextStyle(color: c.textSecondary, fontSize: 12, fontFamily: 'Inter')),
    ],
  );
}
