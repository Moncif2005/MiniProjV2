  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('All Candidates', style: TextStyle(color: c.textPrimary, fontFamily: 'Inter', fontWeight: FontWeight.w700)),
        centerTitle: true,
      ),
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Candidates will appear here when they apply to your jobs', style: TextStyle(color: c.textMuted, fontSize: 14)),
                      ],
                    ),
                  );
                }
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Text('Applied for: ${app['offerTitle'] ?? 'Unknown'}', style: TextStyle(color: c.textMuted, fontSize: 12, fontFamily: 'Inter')),
        ]),
      ]),
    );
  }
