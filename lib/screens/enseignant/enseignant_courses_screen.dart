                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      Text(AppLocalizations.of(context).noCoursesFound, style: TextStyle(color: c.textPrimary, fontSize: 16)),
                    ],
                  ),
                );
              }
  ...
  void _showManageOptions(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(AppLocalizations.of(context).manageCourse, style: TextStyle(fontFamily: 'Inter', fontWeight: FontWeight.bold)),
        content: Text('${AppLocalizations.of(context).actions} "${course.title}"?'),
        actions: [
          // زر الإلغاء
          TextButton(
              ...
              bool? confirmDelete = await showDialog<bool>(
                ...
                builder: (ctx2) => AlertDialog(
                  ...
                  actions: [
                    ...
                    FilledButton(onPressed: () => Navigator.pop(ctx2, true), child: Text(AppLocalizations.of(context).delete)),
                  ],
                ),
              );
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('${course.totalLessons} ${AppLocalizations.of(context).lessons} • ${course.unitsCount} ${AppLocalizations.of(context).units}', style: TextStyle(color: c.textSecondary, fontSize: 12)),
                  ],
                ),
              ),
              // شارة الحالة
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                ...
                child: Text(AppLocalizations.of(context).manage, style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w600)),
              )
            ],
          )
        ],
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                ...
                child: Text(AppLocalizations.of(context).view, style: TextStyle(color: AppColors.purple)),
              ),
            ],
          )
        ],
