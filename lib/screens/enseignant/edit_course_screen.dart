...
class _EditCourseScreenState extends State<EditCourseScreen> {
    ...
    try {
      ...
      if (url != null && mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(AppLocalizations.of(context).imageUploaded), backgroundColor: AppColors.green),
        );
      }
    } catch (e) {
      if (mounted) {
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(AppLocalizations.of(context).courseUpdated), backgroundColor: AppColors.green),
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).editCourse, style: TextStyle(color: c.textPrimary, fontFamily: 'Inter', fontWeight: FontWeight.w700)),
        ...
        actions: [
          if (_isSaving)
            ...
            TextButton(
              ...
              child: Text(AppLocalizations.of(context).save, style: TextStyle(color: AppColors.green, fontWeight: FontWeight.bold, fontSize: 16)),
            ),
        ],
      ),
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildField(AppLocalizations.of(context).description, _descCtrl, c, maxLines: 4),
              const SizedBox(height: 16),
              ...
              Text(AppLocalizations.of(context).editLessonsNote, 
