    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavBar(
        ...
        items: [
          ...
          NavBarItem(icon: Icons.menu_book_rounded, label: AppLocalizations.of(context).navCourses),
...
class _HomeTabContentState extends State<_HomeTabContent> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayName = user.firstName.isNotEmpty ? user.firstName : AppLocalizations.of(context).teacherRole;
            ...
            StreamBuilder<List<CourseModel>>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasData) {
                  ...
                  totalStudents = courses.fold(0, (sum, course) => sum + (course.enrolledStudents));
                }
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: const TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'Inter', fontWeight: FontWeight.w600),
                              ),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(AppLocalizations.of(context).createNewCourse, style: const TextStyle(color: AppColors.green, fontSize: 14, fontFamily: 'Inter', fontWeight: FontWeight.w700)),
                            ],
                          ),
                        ),
                      ),
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Text(AppLocalizations.of(context).seeAll, style: TextStyle(color: c.primary, fontSize: 14, fontFamily: 'Inter', fontWeight: FontWeight.w500)),
                ),
              ],
            ),
            ...
            SizedBox(
              ...
              child: StreamBuilder<List<CourseModel>>(
                ...
                builder: (context, snapshot) {
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(AppLocalizations.of(context).noCoursesYet, style: TextStyle(color: c.textMuted)),
                          const SizedBox(height: 8),
                          ElevatedButton.icon(
                            onPressed: () => Navigator.pushNamed(context, '/enseignant/create-course'),
                            icon: const Icon(Icons.add),
                            label: Text(AppLocalizations.of(context).createFirstCourse),
                  ...
                  final courses = snapshot.data!;
                  // Filter by search query, then take 5
                  final filtered = _searchQuery.isEmpty
                      ? courses
                      : courses.where((c) =>
                          c.title.toLowerCase().contains(_searchQuery) ||
                          c.category.toLowerCase().contains(_searchQuery) ||
                          c.instructorName.toLowerCase().contains(_searchQuery)).toList();
                  final recentCourses = filtered.take(5).toList();
