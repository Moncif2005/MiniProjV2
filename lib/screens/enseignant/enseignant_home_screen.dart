...
class EnseignantHomeScreen extends StatefulWidget {
  ...
  @override
  State<EnseignantHomeScreen> createState() =>
      _EnseignantHomeScreenState();
}

class _EnseignantHomeScreenState
    extends State<EnseignantHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final displayName =
        user.name.isNotEmpty ? user.firstName : 'Alex';
